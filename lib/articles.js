...
import { BRISKET_TIMING_ARTICLE } from "./brisket-timing-article";
...
`,
    ...
    steps: [
      ...
      { name: "Refrigerate uncovered", text: "Place the salted meat on a rack in the refrigerator uncovered. Chicken pieces and steaks: 1-12 hours. Whole chicken: 12-24 hours. Turkey or large roasts: 24-48 hours." },
...
`,
    ...
    steps: [
      ...
      { name: "Pull when probe slides in cleanly", text: "Pull the pork when probe-tender, around 203°F internal. The USDA safe minimum is 145°F, but pulled pork needs the higher temperature for proper shredding." },
      { name: "Rest then pull", text: "Rest at least 30-60 minutes wrapped in a cooler. Pull the pork apart, discarding large fat pockets, and serve." },
    ],
  },
...
`,
    ...
    steps: [
      ...
      { name: "Set up smoker at 225-250°F", text: "Set your pit to 225-250°F and add wood: hickory, cherry, apple, or a blend. No water pan needed." },
      ...
      { name: "Test for doneness", text: "Ribs are done when they bend and crack on the surface when lifted from one end, a probe slides in between the bones with no resistance, and the meat has pulled back from the bone tips by about a quarter inch." },
      { name: "Rest and slice", text: "Rest 10-15 minutes before cutting between the bones to serve." },
    ],
  },
...
`,
    ...
    steps: [
      ...
      { name: "Apply rub and rest before cook", text: "Apply your rub and any injection the day of. Let the butt rest at room temperature for about an hour while you build your fire." },
      ...
      { name: "Rest in cooler then pull", text: "Rest wrapped in a dry cooler for at least 1-2 hours. Pull the pork apart with your hands or forks, mix in the bark pieces, and serve." },
    ],
  },
...
`,
    ...
    howToTime: "PT2H",
    steps: [
      { name: "Dry brine overnight uncovered", text: "Apply salt dry brine to all surfaces including under the skin. Set on a rack uncovered in the fridge overnight. The skin will look dry before the cook, which is exactly what you want." },
      { name: "Apply rub and rest before cook", text: "Apply the rub and a light coat of oil or butter. Let the bird sit at room temperature for 20-30 minutes while the pit comes up to temperature." },
      { name: "Set up smoker at 300-325°F", text: "Set the pit to 300-325°F with no water pan. Add two or three chunks of apple, cherry, or pecan wood." },
      { name: "Smoke breast-side up without opening", text: "Place the bird breast-side up directly on the grate. Insert a leave-in probe into the thickest part of the thigh avoiding bone. Do not spritz, baste, or open the lid repeatedly." },
      { name: "Pull at 165°F in the thigh", text: "Pull when the thigh reaches 165°F. Also verify the breast and wing joint reach 165°F. The USDA safe minimum for all poultry is 165°F." },
...
`,
    ...
    steps: [
      ...
      { name: "Set up smoker at 250-275°F", text: "Set the pit to 250-275°F with oak, hickory, or a blend. No water pan needed for beef ribs." },
...
`,
    ...
    howToTime: "PT4H",
    steps: [
      { name: "Dry brine 48 hours ahead", text: "Apply dry brine of kosher salt to all surfaces including under the breast skin. Place uncovered on a rack in the refrigerator for 48 hours." },
      { name: "Apply rub and oil day of cook", text: "Apply your rub and coat with butter or oil. Let the bird sit at room temperature for 30 minutes while the pit comes up to temperature." },
      { name: "Set up smoker at 300-325°F", text: "Set the pit to 300-325°F with no water pan. Add two or three chunks of apple, cherry, or pecan wood. Do not smoke a whole turkey at 225°F; the bird spends too long in the food-safety danger zone." },
      { name: "Smoke and do not baste", text: "Place the bird on the smoker with a leave-in probe in the thickest part of the inner thigh. Do not spritz or baste; let the heat do the work." },
      { name: "Pull at 165°F in all three spots", text: "Pull when the thigh hits 165°F. Verify the breast and wing joint also read 165°F. The USDA safe minimum for all poultry is 165°F." },
...
`,
    faqs: [
      {
        ...
        a: "Plan on 1 to 1.25 hours per pound at 225°F, about 1 hour per pound at 250°F, or 45-55 minutes per pound at 275°F. A 12-pound brisket takes roughly 9-15 hours depending on pit temperature. Start early and, if it finishes ahead of schedule, monitor any hot hold with a food thermometer at 140°F or warmer.",
      },
      {
    ...
    steps: [
      ...
      { name: "Rest in a cooler", text: "Keep the brisket wrapped and rest in a dry cooler with no ice for 2-4 hours minimum. Resting allows the muscle fibers to reabsorb moisture." },
...
`,
    ...
    howToTime: "PT1H15M",
    steps: [
      { name: "Pat wings dry and add baking powder", text: "Pat wings completely dry with paper towels. Add 1 teaspoon of aluminum-free baking powder per pound to your dry rub and mix thoroughly. Do not add oil." },
...
`,
    ...
    steps: [
      ...
      { name: "Keep wrapped through the rest", text: "When done, transfer to a dry cooler still wrapped and rest for 2-4 hours. The wrap retains heat and moisture through the rest period." },
    ],
  },
...
`,
    ...
    steps: [
      ...
      { name: "Rinse and form the pellicle", text: "Rinse under cold water, pat dry, then place on a rack in the refrigerator uncovered for 1-3 hours until a shiny, tacky pellicle forms on the surface." },
      ...
      { name: "Rest and serve", text: "Rest 5-10 minutes after pulling. Serve warm or refrigerate and serve cold the next day. Smoked salmon keeps refrigerated for 3-4 days." },
    ],
  },
...
`,
    ...
    steps: [
      ...
      { name: "Season or marinate", text: "Either marinate in olive oil, soy, garlic, and brown sugar for 2-4 hours, or apply a sweet dry rub 30 minutes to overnight before smoking." },
      ...
      { name: "Smoke with probe to 140-143°F", text: "Place the tenderloin on the grate with a leave-in probe in the thickest part. Smoke until 140-143°F internal." },
      { name: "Pull and rest to 145°F", text: "Pull at 140-143°F and rest 3-5 minutes. Carryover heat will bring it to 145°F, the USDA safe minimum for pork. Waiting until 145°F on the probe will overcook it." },
...
<ul>
  ...
  <li><strong>Heavy wood:</strong> Mesquite overwhelms pork loin's mild flavor. Stick to apple, cherry, pecan, or a light oak.</li>
    ...
    howToTime: "PT2H",
    steps: [
      { name: "Brine overnight", text: "Submerge the loin in a salt-and-sugar brine for 4-12 hours in the refrigerator. Rinse and pat completely dry before continuing." },
      { name: "Apply rub and rest", text: "Coat all surfaces with your rub. Let the loin rest at room temperature for 30 minutes while the smoker comes up to temperature." },
      ...
      { name: "Smoke to 145°F internal", text: "Place the loin on the grate with a leave-in probe in the thickest center section. Smoke until 145°F internal, roughly 20-25 minutes per pound." },
...
<ul>
  ...
  <li><strong>Skipping the sear:</strong> You can smoke tri-tip directly to 130-132°F without a sear, but the crust is what makes it memorable. The extra 10 minutes for the sear is worth it.</li>
    ...
    steps: [
      ...
      { name: "Smoke to 115-120°F internal", text: "Set smoker to 225-250°F with red oak, white oak, or cherry. Smoke the tri-tip to 115-120°F internal, about 60-90 minutes for a 2-3 lb roast." },
      { name: "Sear over high heat", text: "Pull the tri-tip and rest 5 minutes while a grill or cast iron pan gets very hot (500°F+). Sear 2-3 minutes per side until a dark crust forms." },
      { name: "Rest 10 minutes", text: "Rest on a cutting board for 10 minutes. The internal temperature will carry to 130-132°F for medium-rare." },
...
<ul>
  ...
  <li><strong>Not resting long enough:</strong> Carving a prime rib that has not rested will release a significant amount of juice. 30 minutes minimum, 45 is better on a large roast.</li>
    ...
    steps: [
      ...
      { name: "Apply herb crust and rest", text: "On cook day, coat with a butter, rosemary, thyme, garlic, black pepper, and Dijon paste. Let the roast sit at room temperature for 30-60 minutes." },
      ...
      { name: "Pull at 120-125°F internal", text: "Smoke to 120-125°F for medium-rare, roughly 15-20 minutes per pound. Carryover will carry it to 130-135°F during the rest." },
      { name: "Rest 30-45 minutes", text: "Tent loosely with foil and rest at least 30 minutes. This step is not optional; carryover adds 8-12°F and the juices need to redistribute." },
      { name: "Optional sear for crust", text: "After the rest, blast at 500°F for 10-15 minutes for a dark crust. Carve immediately after the sear without resting again." },
    ],
  },
...
<p>Assemble through step 4 the night before and refrigerate, covered. Pull it out 30 minutes before smoking to take the chill off. Add about 15 extra minutes to the smoke time if it starts cold.</p>
    ...
    steps: [
      ...
      { name: "Smoke uncovered at 225-250°F", text: "Set the smoker to 225-250°F with apple, cherry, or pecan wood. Place the uncovered pan on the smoker for 60-90 minutes, stirring once at 30 minutes." },
      ...
      { name: "Serve from the pan", text: "Pull when the surface has a slight set crust and breadcrumbs are golden. Serve directly from the skillet or pan." },
    ],
  },
];
