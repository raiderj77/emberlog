...
export const metadata = pageMetadata({
  ...
  description:
    "Free BBQ planning calculators and references: smoke time, meat per person, dry-brine salt, doneness temperatures, and wood pairing. No sign-up.",
  canonical: "/tools/",
});
    ...
    <>
      ...
      <Container className="py-10">
        ...
        <p className="mt-3 max-w-2xl text-muted">
          Free and fast, with safety endpoints separated from planning estimates. No sign-up. Pair the tools with the free <Link href="/log/" className="font-medium text-ember-600 hover:text-ember-700">cook log</Link> to track how a cook actually went.
        </p>
